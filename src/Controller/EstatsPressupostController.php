...
/**
 * @Route("/estatsPressupost")
 */
class EstatsPressupostController extends AbstractController
{
    /**
    ...
    {
        $estatsPressupost = $entityManager
            ->getRepository(EstatsPressupost::class)
            ->findAll();

        return $this->render('estatsPressupost/index.html.twig', [
            'estatsPressupost' => $estatsPressupost,
            'form' => $form,
        ]);
    }
